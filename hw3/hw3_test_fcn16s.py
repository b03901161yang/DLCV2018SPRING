...
x_valid /= 255
########################################################
def FCN16(input_shape=None, num_classes=2):
    train_able = False
    ...
    o = Dropout(0.5)(o)
    o = Conv2D(num_classes, (1, 1), kernel_initializer='he_normal', activation = 'linear' , padding='valid')(o)

    o_up2 = Conv2DTranspose(filters = num_classes, kernel_size = (4, 4), strides = (2, 2), padding='same', use_bias = False)(o)
    
    x_pool4 = Conv2D(num_classes, (1, 1), kernel_initializer='he_normal', activation = 'linear' , padding='valid')(x_pool4)
    # o_up2, x_pool4 = crop(o_up2, x_pool4, input img)
    o_fuse_pool4 = Add()([o_up2, x_pool4])
    o_up16 = Conv2DTranspose(filters = num_classes, kernel_size = (32, 32), strides = (16, 16), padding='same', activation='softmax', use_bias = False)(o_fuse_pool4)
...
model.summary()
model.load_weights("fcn16s_iou69.h5")
